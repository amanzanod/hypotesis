    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible_at', models.DateTimeField(blank=True, null=True, verbose_name='visible at')),
                ('state_at', models.DateTimeField(blank=True, null=True, verbose_name='state at')),
                ('alias', models.CharField(error_messages={'unique': 'A context of this type with that alias already exists.'}, max_length=20, primary_key=True, serialize=False, verbose_name='alias')),
                ('description', models.TextField(blank=True, max_length=500, null=True, verbose_name='description')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='context.Category', verbose_name='category')),
                ('format', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='context.Format', verbose_name='format')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='context.Context', verbose_name='parent')),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='context.State', verbose_name='state')),

  ...
  <div id="router-view">
      ...
      <div class="container-view">
          ...
          <div class="users_total">
              ...
              <b-form-group>
                  <b-form-checkbox-group id="checkbox-group-1" v-model="users_selected" name="flavour-1">
                      <b-table striped
                               hover
                               :items="items"
                               :fields="fields"
          ...
          <div class="assign_buttons">
              <div class="assign_btn"></div>
              <div class="unassign_btn"></div>
          </div>
          ...
          <div class="users_selected">
              ...
              <b-form-group>
                  <b-form-checkbox-group id="checkbox-group-2" v-model="users_selected" name="flavour-2">
                      <b-table striped
                               hover
                               :items="items2"
                               :fields="fields2"

...
def forwards_func(apps, schema_editor):
    admin_username = os.environ.get('HYP_ITEM_SUPER_USER', 'admin')
    admin_email = os.environ.get('HYP_ITEM_SUPER_USER_EMAIL', '')
    admin_pass = os.environ.get('HYP_ITEM_SUPER_USER_PASS', '1234')
